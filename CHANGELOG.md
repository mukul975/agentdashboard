...
* serve pre-built dist/ as static files from Express instead of spawning vite; vite is a devDependency not installed globally so npx vite failed with "Cannot find module 'vite'"
